...
return ( <div className="w-full text-white p-8"> <h1 className="text-5xl font-bold mb-2">
...
<div className="flex flex-wrap gap-3 mb-8">
  ...
  <button
    onClick={() => {
      setPrompt("Carro esportivo vermelho acelerando pelas ruas de Mônaco, cinematográfico");
      setStyle("Cinemático");
    }}
  ...
  <button
    onClick={() => {
      setPrompt("Personagem estilo videogame caminhando por uma cidade moderna");
      setStyle("3D");
    }}
    className="px-4 py-3 rounded-xl bg-zinc-900 border border-zinc-800 hover:border-purple-500"
  >
...
<div className="mt-8 p-4 rounded-2xl bg-purple-600/10 border border-purple-500/20">
  ...
  <p className="text-zinc-500 text-sm">
    por mês
     ...
     <Link href="/premium">
    <button className="w-full bg-gradient-to-r from-purple-600 to-pink-600 py-4 rounded-2xl font-bold">
